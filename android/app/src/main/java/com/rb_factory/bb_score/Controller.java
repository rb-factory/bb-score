<<<<<<< Updated upstream:android/app/src/main/java/com/rb_factory/bb_score/Controller.java
...
public class Controller {
    ...
    public void setCurrentLocation(Optional<Location> currentLocation) {
        if (currentLocation.isPresent()) this.currentLocation = currentLocation;
    }
}
>>>>>>> Stashed changes:app/src/main/java/com/rb_factory/bb_score/Controller.java
